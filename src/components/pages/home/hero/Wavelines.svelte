<script lang="ts">
  export let waveLines1DesktopRef: HTMLObjectElement;
  export let waveLines2DesktopRef: HTMLObjectElement;
  export let waveLines1MobileRef: HTMLObjectElement;
  export let waveLines2MobileRef: HTMLObjectElement;
</script>
